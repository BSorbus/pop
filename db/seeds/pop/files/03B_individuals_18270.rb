...
puts ""
puts "#####  03B_individuals_18270.rb  #####"

############################################################################################
puts "... load from db/seeds/pop/files/osoba_18270.csv... start..." 

File.open(File.join("db/seeds/pop/files/log", 'osoba_18270.log'), 'a+') do |f|
  f.puts "#####  03B_individuals_18270.rb  #####"
  f.puts "... load from db/seeds/pop/files/osoba_18270.csv... start..."
end 

CSV.foreach("db/seeds/pop/files/osoba_18270.csv", { encoding: "WINDOWS-1250:UTF-8", 
                                    headers: true, 
  ...
  @individual = Individual.create(id:                   id_with_offset( row[:id_osoba], DB18270_OFFSET_OSOBA ),
                                  first_name:           row[:imie], 
                                  ...
                                  created_at:           individual_created_at_first_rec( id_with_offset( row[:id_osoba], DB18270_OFFSET_OSOBA ) ),
  ...
  if @individual.valid?
    ...
    File.open(File.join("db/seeds/pop/files/log", 'osoba_18270.error'), 'a+') do |f|
      f.puts "ERROR(s)"
...
puts "#####  END OF 03B_individuals_18270.rb  #####"
puts ""
