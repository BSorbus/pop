...
puts ""
puts "#####  02B_companies_18270.rb  #####"

############################################################################################
puts "... load from db/seeds/pop/files/firma_18270.csv... start..."

File.open(File.join("db/seeds/pop/files/log", 'firma_18270.log'), 'a+') do |f|
  f.puts "#####  02B_companies_18270.rb  #####"
  f.puts "... load from db/seeds/pop/files/firma_18270.csv... start..."
end 

CSV.foreach("db/seeds/pop/files/firma_18270.csv", { encoding: "WINDOWS-1250:UTF-8", 
                                          headers: true, 
  ...
  @company = Company.create(      id:                   id_with_offset( row[:id_firma], DB18270_OFFSET_FIRMA ), 
                                  short:                row[:skrot], 
                                  name:                 row[:nazwa],
                                  ...
                                  created_at:           company_created_at_first_rec(id_with_offset(row[:id_firma], DB18270_OFFSET_FIRMA)),
  ...
  if @company.valid?
    ...
    File.open(File.join("db/seeds/pop/files/log", 'firma_18270.error'), 'a+') do |f|
      f.puts "ERROR(s)"
...
puts "#####  END OF 02B_companies_18270.rb  #####"
puts ""
