class DeclarationsAccession1Pdf < Prawn::Document
  ...
  def data(coverage)
    ...
    move_down 57
    text "6. Ponadto upoważniam pracodawcę do potrącania składki ubezpieczeniowej z wynagrodzenia za pracę, " +
         "zasiłku na wypadek choroby lub macierzyńskiego i innych wypłat.", size: 6, :align => :justify
  ...
  def footer
    draw_text "Ubezpieczenie obsługuje: #{@rotation.insurance.user.name} - #{@rotation.insurance.user.agent_number}", :at => [320, 41], size: 7    
